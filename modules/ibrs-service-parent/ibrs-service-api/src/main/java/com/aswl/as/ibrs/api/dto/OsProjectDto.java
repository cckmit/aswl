...
@Data
public class OsProjectDto extends TreeEntity<OsProjectDto> {
    ...
    @ApiModelProperty(value = "项目管理员账号")
    private String adminAccount;

    @ApiModelProperty(value = "设备箱数量")
...
//    @NotBlank(message="系统编号不能为空")
    ...
    public OsProjectDto(Project p) {
        ...
        adminAccount = p.getAdminAccount();
        boxNum = p.getBoxNum();
        cameraNum = p.getCameraNum();
       ...
       // parentId=null;
        sort=0;
        this.type="2";
        this.sysLogo =p.getSysLogo();
        this.sysName= p.getSysName();
