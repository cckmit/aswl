...
public class PasswordUtil {
	...
	public static final String Salt = "22127508";//密钥
	...
	public static void main(String[] args) {
		//加密 参数:明文的 用户名 密码 加盐
		String encrypt = encrypt("123456", "1234567887654321", PasswordUtil.getStaticSalt());
		System.out.println(encrypt);
		//解密
		String decrypt = decrypt("e47d2e354af706a9", "1234567887654321", PasswordUtil.getStaticSalt());
