...
import com.aswl.as.auth.security.CustomTokenConverter;
import com.aswl.as.common.security.core.ClientDetailsServiceImpl;
import com.aswl.as.common.security.core.CustomUserDetailsService;
import com.aswl.as.common.security.exceptions.CustomOauthException;
...
public class CustomAuthorizationServerConfigurer extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    public CustomAuthorizationServerConfigurer(AuthenticationManager authenticationManager, RedisConnectionFactory redisConnectionFactory, DataSource dataSource, KeyProperties keyProperties,CustomUserDetailsService customUserDetailsService) {
