...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Swagger API")
                .description("https://gitee.com/wells2333/as-microservice-as")
                .termsOfServiceUrl("https://gitee.com/wells2333/as-microservice-as")
                .contact(new Contact("aswl", "https://gitee.com/wells2333/as-microservice-as", "aswl@qq.com"))
                .version("2.0")
                .build();
    }
