...
import com.aswl.as.common.core.utils.okhttp.LogInterceptor;
import com.aswl.as.common.core.utils.okhttp.OkHttpRequestBodyUtil;
import com.aswl.as.common.core.utils.okhttp.SSLSocketClient;
import okhttp3.*;
...
/**
 * okHttp工具类 原来是OkHttpUtil 类，但是复制过来改了超时等配置
 *
 * @author aswl.com
 * @date 2018-09-07 20:31
 */
public class OsHttpUtil {

    private static final Logger logger = LoggerFactory.getLogger(OsHttpUtil.class);

    /**
     * 单例对象
     */
    private static OsHttpUtil instance;
...
//                .sslSocketFactory(SSLSocketClient.getSSLSocketFactory())
     ...
     * @return OkHttpClient
     */
    public synchronized static OsHttpUtil getInstance() {
        if (instance == null)
            instance = new OsHttpUtil();
        return instance;
    }
