package com.aswl.as.common.security.constant;
...
public class SecurityConstant {
     ...
     * 项目ID请求头
     */
    public static final String IS_ADMIN_HEADER = "Is-Admin";

    /**
     * 默认系统编号
     */
    public static final String SYS_CODE = "AS";

    /**
     * 默认租户编号
     */
    public static final String DEFAULT_TENANT_CODE = "aswl";
